...
class MyUser(AbstractBaseUser):
    ...
    address = models.CharField(verbose_name='地址',max_length=200,default='',blank=True,null = True)
    major = models.TextField(verbose_name='个人简介',default='', blank=True,null = True)
